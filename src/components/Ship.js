...
function ShipModel(props, { children }) {
  const { nodes, materials } = useGLTF('/spaceship.gltf', "https://www.gstatic.com/draco/versioned/decoders/1.4.0/")
...
useGLTF.preload('/spaceship.gltf', "https://www.gstatic.com/draco/versioned/decoders/1.4.0/")
